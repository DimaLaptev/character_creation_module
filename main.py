...
def attack(char_name: str, char_class: str) -> str:
    """Generation messages about damage during the battle 
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Generation messages about defence during the battle 
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Generation messages about use a special skill during the battle 
    """
    if char_class == 'warrior':
